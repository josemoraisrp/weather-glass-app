...
const iconeClima = document.querySelector(".icone");
...
async function buscarCidade() {
  ...
  if (cidade === "") {
    loading.innerHTML = "Digite uma cidade";
    return;
  }
  ...
  weatherInfo.classList.add("loading-weather");
  botao.innerHTML = "Buscando...";
  ...
  try {
    ...
    if (dados.cod == "404") {
      loading.innerHTML = "Cidade não encontrada";
      botao.innerHTML = "Buscar";
      weatherInfo.classList.remove("loading-weather");
      return;
    }
    ...
    loading.innerHTML = "Erro ao buscar cidade";
    botao.innerHTML = "Buscar";
    weatherInfo.classList.remove("loading-weather");
    console.log(erro);
  }
